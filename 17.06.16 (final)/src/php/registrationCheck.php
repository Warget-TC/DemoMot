...
if (empty($pseudo) OR empty($password) OR empty($fristName) OR empty($lastName) OR empty($email) OR empty ($description)) {
    ...
    $db = new DbConnexion();
    $db->addUser($pseudo, $password, $fristName, $lastName, $email, $name_file,$description);
