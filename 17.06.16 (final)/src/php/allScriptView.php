                                ...
                                for ($teacherCptr = 0; $teacherCptr < count($allScript); $teacherCptr++) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="positive"><a
                                            ...
                                            <span><i class="forward mail icon"></i></span>Détail &nbsp &nbsp &nbsp</a>

                                        <a
                                                href="<?php /*Fait un lien sur la page Detail en prenant l'id */
                                                print("commentSee.php?id=" . $allScript[$teacherCptr]['idScript']) ?>"
                                            <span><i class="flag icon"></i></span>Commentaires </a>
                                        </td>
                                    </tr>
